...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/faq.jpg);">
	...
	<section class="bg2-pattern p-t-116 p-b-110 t-center p-l-15 p-r-15" style="background-image: url(images/pattern2.png);">
		...
		<p class="t-center size32 m-l-r-auto">
			Will OwlHub solve my university assignments? OwlHub does not solve university assignments for students, 
			it is here only to educate the beneficiary and not to assist them in any unethical means Will OwlHub provide 
			mentors to sit for my exams? It goes without saying that OwlHub does not engage itself in such activities, 
			we strictly provide a platform for learners to connect and get the knowledge they want to seek out. Will 
			OwlHub hand out any solutions to questions/exercise/problems? While our course experts are permitted to help 
			solve the questions, they are not in any way guided to give out a soft/hard copy of the solutions.
		</p>
	</section>
		...
		<div class="container t-center">
			...
			<div class="row">
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/step-01.png" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/step-02.png" alt="IGM-AVATAR"></a>
						</div>
						...
						<div class="text-blo5 size34 t-center bo-rad-10 bo7 p-t-90 p-l-35 p-r-35 p-b-30">
							...
							<p class="t-center">
								Search for your course and suitable timin
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/step-03.png" alt="IGM-AVATAR"></a>
						</div>
						...
						<div class="text-blo5 size34 t-center bo-rad-10 bo7 p-t-90 p-l-35 p-r-35 p-b-30">
							...
							<p class="t-center">
								Post your problem along with your description and study materials
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/step-04.png" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/step-05.png" alt="IGM-AVATAR"></a>
						</div>
